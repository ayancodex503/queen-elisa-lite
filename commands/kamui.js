...
//Change the name 'kamui' if you want a different name for your command, and also the file must have the same name as your command.
async function kamuiCommand(message, client){
...
export default kamuiCommand;//change le nom 'kamui' si tu veux un autre nom pour ta commande 